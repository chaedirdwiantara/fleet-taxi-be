...
const EXPECTED_OPERATIONS = [
  ...
  'DELETE /partner/portal/driver-registrations/{id}',
  ...
  'GET /partner/portal/debt-summary',
  'GET /partner/portal/debt-summary/export',
  'GET /partner/portal/debt-summary/filters',
  'GET /partner/portal/driver-registrations',
  'GET /partner/portal/driver-registrations/{id}',
  'GET /partner/portal/driver-resignations',
  'GET /partner/portal/driver-resignations/{id}',
  ...
  'PATCH /partner/portal/driver-registrations/{id}',
  'PATCH /partner/portal/drivers/{id}',
  ...
  'POST /partner/portal/driver-registrations/{id}/deposit',
  'POST /partner/portal/driver-registrations/{id}/deposit/decision',
  'POST /partner/portal/driver-registrations/{id}/doc-check',
  'POST /partner/portal/driver-registrations/{id}/verify',
  'POST /partner/portal/driver-resignations/{id}/deposit-return',
  'POST /partner/portal/driver-resignations/{id}/deposit-return/decision',
  'POST /partner/portal/drivers/documents/{driverId}/presign',
  'POST /partner/portal/drivers/documents/{driverId}/{documentId}/confirm',
  'POST /partner/portal/drivers/{id}/resign',
