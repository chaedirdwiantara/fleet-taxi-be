...
const EXPECTED_OPERATIONS = [
  ...
  'DELETE /partner/portal/deposit-installments/{id}',
  ...
  'DELETE /partner/portal/rentals/invoice-settings/{kind}',
  ...
  'GET /partner/portal/rentals/invoice-settings',
  'GET /partner/portal/rentals/invoice-settings/{kind}/file',
  ...
  'PUT /partner/portal/deposit-installments/{id}',
  ...
  'PUT /partner/portal/rentals/invoice-settings/{kind}',
